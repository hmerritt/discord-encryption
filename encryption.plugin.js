    ...
    initializeComponents()
    {
        ...
        */
        ...
        this.encryption.get.state = () =>
        {
            ...
            let chatState   = this.userData[channelId] ? this.userData[channelId].state : false;
        ...
        */
        ...
        {
            return `
                <button ${this.script.name}="encryptionButton" state="${this.encryption.get.state()}" class="encryptionButton">
