...
const downloadRequiredLibraryIfMissing = () => {
    if (window.ZeresPluginLibrary)
        return;
    window.BdApi.UI.showConfirmationModal("Library Missing", `The library plugin needed for ${config.nameTitle} is missing. Please click Download Now to install it.`, {
 ...
 */
const deriveKey = (password) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 */
const encrypt = (plaintext, password) => __awaiter(void 0, void 0, void 0, function* () {
    const enc = new TextEncoder();
    // Generate a random salt (16 bytes) for this specific message
    const salt = window.crypto.getRandomValues(new Uint8Array(16));
    const keyMaterial = yield deriveKey(password);
    ...
    const key = yield window.crypto.subtle.deriveKey({
        ...
        iterations: 100000,
        hash: "SHA-256"
    }, keyMaterial, ALGO, false, ["encrypt"]);
    // Generate a unique IV (12 bytes) for this message
    // 12 bytes is the standard recommended size for AES-GCM
    const iv = window.crypto.getRandomValues(new Uint8Array(12));
    // Encrypt
    const ciphertext = yield window.crypto.subtle.encrypt({ name: "AES-GCM", iv: iv }, key, enc.encode(plaintext));
 ...
 */
const decrypt = (base64Bundle, password) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const key = yield window.crypto.subtle.deriveKey({
        ...
        iterations: 100000,
        hash: "SHA-256"
    }, keyMaterial, ALGO, false, ["decrypt"]);
    // Decrypt
    const decrypted = yield window.crypto.subtle.decrypt({ name: "AES-GCM", iv: iv }, key, data);
...
const isMessageEncrypted = (msg) => msg === null || msg === void 0 ? void 0 : msg.startsWith(PREFIX);
const decryptAllMessages = (channelData) => __awaiter(void 0, void 0, void 0, function* () {
...
const getUserData = () => {
    ...
    try {
        if (typeof ((_b = (_a = window === null || window === void 0 ? void 0 : window.BdApi) === null || _a === void 0 ? void 0 : _a.Data) === null || _b === void 0 ? void 0 : _b.load) !== "undefined") {
            const getUserData = window === null || window === void 0 ? void 0 : window.BdApi.Data.load(config.name, config.name);
...
const saveUserData = (userData) => {
    var _a, _b;
    try {
        if (typeof ((_b = (_a = window === null || window === void 0 ? void 0 : window.BdApi) === null || _a === void 0 ? void 0 : _a.Data) === null || _b === void 0 ? void 0 : _b.save) !== "undefined") {
            return window === null || window === void 0 ? void 0 : window.BdApi.Data.save(config.name, config.name, JSON.stringify(userData));
        }
        if (typeof localStorage !== "undefined") {
        ...
        const plugin = (Plugin, Api) => {
            ...
            return class Encryption extends Plugin {
                ...
                start() {
                    ...
                    Patcher.instead(DiscordModules.MessageActions, "sendMessage", (thisObject, args, originalFunction) => __awaiter(this, void 0, void 0, function* () {
                        let message = args[1].content;
                        if (isEncryptionOn(getUserData(), getChannelId()) &&
                            !isMessageEncrypted(message) &&
                            (message === null || message === void 0 ? void 0 : message.length) > 0) {
                            const channelPass = getOrCreateUserData(getUserData(), getChannelId()).password;
                            const enc = yield encrypt(message, channelPass);
